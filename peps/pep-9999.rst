...
(see `rejected ideas <PEP 9999 rejected_>`_): we keep 3 as the major version,
...
avoids confusion with Ubuntu versions which use YY.mm. However, this is rejected as
...
The author `proposed calendar versioning
<https://hugovk.github.io/python-calver/>`__
at the `Python Language Summit 2024
